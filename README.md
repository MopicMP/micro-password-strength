...
[![PyPI version](https://badge.fury.io/py/micro-password-strength.svg)](https://pypi.org/project/micro-password-strength/)
...
```bash
pip install micro-password-strength
```
...
# Basic usage
result = strength("your input here")
print(result)
```
...
result = strength("Hello World")

# Example 2: Batch processing
from micro_password_strength import batch
